    ...
    return (
        ...
        >
            ...
            <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
                <div className="mb-12 lg:mb-0 lg:flex lg:flex lg:flex-col">

                <h2 className="headLine-2 lg:max-w-max[12ch]">
                ...
                <form 
                action="https://getform.io/f/blllmzxb"
                method="POST"
                ...
                >
                    <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                        ...
                        <div className="mb-4">
                            ...
                            autoComplete="email"
                            required
                            placeholder="michaelsaams20@gmail.com"
